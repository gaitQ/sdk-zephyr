...
#elif defined(CONFIG_BT_CTLR_ISO)
#define BT_BUF_ISO_RX_SIZE BT_BUF_ISO_SIZE(CONFIG_BT_CTLR_ISO_RX_BUFFER_SIZE)
#define BT_BUF_ISO_RX_COUNT CONFIG_BT_CTLR_ISO_RX_BUFFERS
#else
